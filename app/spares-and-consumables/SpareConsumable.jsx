...
import { Filter, Droplets, Cog, Settings, Wrench, Cpu, Thermometer, Fan } from 'lucide-react';
    ...
    return (
        <>
            <main className="bg-slate-50">
                ...
                <section className="bg-white py-10">
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        <div className="text-center">
                            <span className="text-sm font-semibold tracking-widest text-cyan-600 uppercase">Key Benefits</span>

                            <h2 className="mt-3 text-4xl font-bold text-slate-900">Key Benefits</h2>

                            <p className="mx-auto mt-3 max-w-3xl text-slate-600 md:mt-6 md:text-lg">
                                Using quality compressor spares and consumables helps maintain system performance while reducing maintenance costs and improving
                ...
                <section className="bg-slate-50 px-5 py-6 md:py-10">
                    <div className="container mx-auto px-3 lg:px-8">
                        <div className="max-w-3xl">
                            <span className="text-sm font-semibold tracking-wider text-blue-600 uppercase">Spare Parts Portfolio</span>

                            <h2 className="mt-3 text-3xl font-bold text-slate-900 md:text-4xl">Our Product Range</h2>

                            <p className="mt-4 leading-5 text-slate-600 md:leading-6">
                                Comprehensive spare parts and maintenance components for industrial compressed air systems.
                            </p>
                        </div>
                            ...
                            {products.map((item, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <h3 className="mt-2 text-sm font-semibold text-slate-900 md:text-base">{item.title}</h3>
                                    </div>
                                );
                            })}
                        </div>
                ...
                <section className="bg-gradient-to-r from-cyan-600 to-blue-700 py-7 lg:py-9 xl:py-15">
                    <div className="mx-auto max-w-5xl px-6 text-center">
                        <h2 className="text-3xl font-bold text-white md:text-4xl">Need Compressor Spares & Consumables?</h2>

                        <p className="mt-6 text-cyan-100 md:text-lg md:leading-8">
                            Ensure uninterrupted performance with premium-quality compressor spares and consumables from Eutair Equipments LLP. Our team is
                            ready to help you find the right replacement parts for your compressed air system.
                        </p>

                        <div className="mt-10 flex flex-wrap justify-center gap-3 md:gap-5">
                            <Link
                                href="tel:+919717159766"
                                className="rounded-xl bg-white px-5 py-4 font-semibold text-slate-900 transition hover:scale-105 md:px-8"
                            >
                                Contact Us
                            </Link>
                            ...
                            <button
                                onClick={() => setOpen(true)}
                                href="/contact"
                                className="flex items-center gap-2 rounded-xl border border-white bg-transparent px-5 py-4 font-semibold text-white transition hover:bg-white hover:text-slate-900 md:px-8"
                            >
                                Request a Quote
            ...
            <section className="relative overflow-hidden px-5 py-6 md:px-10 md:py-10">
                {/* Background */}
                ...
                <div className="relative z-10 container mx-auto lg:px-8">
                    ...
                    <div className="max-w-3xl">
                        ...
                        <h2 className="mt-3 text-3xl font-bold text-slate-900 md:text-4xl lg:text-5xl">Brands We Support</h2>

                        <p className="text-md mt-3 text-slate-600 md:leading-8">
                            We provide genuine, OEM-equivalent, and compatible spare parts for leading compressor brands:
                        </p>
                    </div>
                    ...
                    <div className="mt-5 grid grid-cols-2 gap-3 md:gap-6 lg:grid-cols-5">
                        ...
                        {/* Last Card */}
                        <div className="hidden h-40 items-center justify-center rounded-3xl border border-dashed border-sky-300 bg-white/60 p-8 text-center shadow-lg shadow-slate-100 md:flex">
