        ...
        <div className="relative mx-auto max-w-7xl px-6 py-20 lg:px-8">
          <div className="max-w-4xl">
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-200">
              ...
              high-performance replacement parts for a wide range of industrial
              screw air compressors, helping industries minimize downtime,
              improve equipment reliability, and maximize operational
              productivity.
            </p>
        ...
        <div className="grid gap-14 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600">
              ...
              maintain compressor efficiency, extend equipment life, and reduce
              unexpected breakdowns across industrial applications.
            </p>
          </div>
