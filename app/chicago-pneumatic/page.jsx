...
export default function Page() {
     ...
     <div className="grid lg:grid-cols-2 gap-12 items-center">
      ...
      <div>
         ...
         <p className="mt-6 text-lg text-slate-600 leading-relaxed text-justify">
           Eutair Equipments LLP offers a comprehensive range of Chicago           Pneumatic Screw Air Compressors designed to deliver exceptional
  ...
  <p className="mt-2 text-center text-md text-slate-600 leading-relaxed">
      ...
      {/* BENEFITS */}
 <section className="py-9 px-20 bg-white">
