...
import { ShieldCheck, Wrench, Cog, Settings, Gauge, BarChart3, ArrowRight, CheckCircle2 } from 'lucide-react';
    ...
    return (
        <main className="bg-white">
            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950">
                ...
                <div className="relative z-10 container mx-auto px-6 py-10 lg:px-8">
                    <div className="max-w-4xl">
                        ...
                        <h1 className="mt-8 text-5xl leading-tight font-bold text-white lg:text-5xl">EutAir Service & Genuine Parts Support</h1>

                        <p className="mt-8 text-2xl font-medium text-slate-200">
                            Reliable Service Solutions for Maximum Equipment Performance and Long-Term Reliability
                        </p>
                        ...
                        <div className="mt-10 flex flex-wrap gap-4">
                            ...
                            <button
                                ...
                                className="rounded-xl border border-white/20 bg-white/5 px-8 py-4 font-semibold text-white backdrop-blur-sm"
                            >
            ...
            <section className="relative overflow-hidden py-10">
                ...
                <div className="absolute top-0 left-0 h-72 w-72 rounded-full bg-blue-100 opacity-50 blur-3xl" />
                <div className="absolute right-0 bottom-0 h-72 w-72 rounded-full bg-cyan-100 opacity-50 blur-3xl" />
                ...
                <div className="relative z-10 container mx-auto px-6 lg:px-8">
                    <div className="grid items-center gap-16 lg:grid-cols-2">
                        ...
                        <div>
                            ...
                            <h2 className="mt-6 text-4xl leading-tight font-bold text-slate-900">
                                Reliable Service Solutions for Maximum Equipment Performance
                            </h2>

                            <div className="mt-8 space-y-6">
                                <p className="text-lg leading-9 text-slate-900">
                                    Maintaining compressed air equipment goes beyond routine maintenance. Consistent performance, operational efficiency, and
                                    equipment longevity depend on timely servicing, genuine replacement components, and expert technical support.
                                </p>

                                <p className="text-lg leading-9 text-slate-900">
                                    Comprehensive Service & Parts Support helps industrial facilities reduce unplanned downtime, extend equipment life, and
                                    maintain optimal operating performance through preventive maintenance programs, technical assistance, repair services, and
                                    access to genuine spare parts and consumables.
                                </p>

                                <p className="text-lg leading-9 text-slate-900">
                                    Whether supporting a single compressor installation or a large compressed air network, service solutions are designed to
                                    keep critical operations running smoothly and efficiently.
                                </p>
                            </div>
                            ...
                            <div className="mt-10 flex flex-wrap gap-4">
                                ...
                                <div className="rounded-2xl border border-slate-200 bg-white px-5 py-4 shadow-sm">
                                    <span className="text-sm font-semibold text-slate-900">Genuine Spare Parts</span>
                                </div>

                                <div className="rounded-2xl border border-slate-200 bg-white px-5 py-4 shadow-sm">
                                    <span className="text-sm font-semibold text-slate-900">Technical Support</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative">
                            ...
                            <div className="relative overflow-hidden rounded-[32px] border border-slate-200 bg-white p-3 shadow-2xl">
                                <img src="/drill-cp.jpeg" alt="Service Support" className="h-[550px] w-full rounded-[24px] object-cover" />
                            </div>
                            ...
                            <div className="absolute -bottom-6 -left-6 hidden rounded-3xl bg-white p-6 shadow-2xl lg:block">
                                ...
                                <p className="mt-1 text-sm text-slate-600">Service & Technical Support</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="pb-7">
                <div className="container mx-auto px-6 lg:px-8">
                    <div className="text-center">
                        <span className="text-sm font-semibold tracking-widest text-blue-600 uppercase">Service Excellence</span>

                        <h2 className="mt-4 text-4xl font-bold text-slate-900 lg:text-5xl">Solutions That Keep Your Operations Running</h2>

                        <p className="mx-auto mt-6 max-w-4xl text-lg leading-8 text-slate-600">
                            Industrial operations depend on reliable compressed air systems to maintain productivity and process continuity. Structured service
                            programs, quality replacement parts, and technical expertise help ensure equipment operates at peak performance while minimizing
                            lifecycle costs.
                        </p>
                    </div>
                </div>
            ...
            <section className="bg-slate-50 py-14">
                <div className="container mx-auto px-6 lg:px-8">
                    <div className="mx-auto max-w-5xl text-center">
                        <h2 className="text-4xl font-bold text-slate-900">Why Service & Genuine Parts Matter</h2>

                        <p className="mt-8 text-lg leading-9 text-slate-700">
                            A compressed air system represents a critical utility asset for many industrial operations. Without proper maintenance and quality
                            replacement components, equipment performance can decline over time, leading to higher energy consumption, increased breakdown risk,
                        ...
                        <div className="mt-12 grid gap-4 md:grid-cols-3">
                            {[
                                ...
                                <div key={i} className="rounded-2xl border border-slate-200 bg-white p-5 font-medium text-slate-700 shadow-sm">
                                    {item}
                                </div>
                            ))}
                        </div>
          ...
          <div className="rounded-[32px] border border-white/10 bg-gradient-to-r from-blue-600 to-cyan-500 p-12 text-center">
            ...
            <section className="py-10">
                <div className="container mx-auto max-w-5xl px-6 lg:px-8">
                    <h2 className="mb-8 text-center text-4xl font-bold text-slate-900">Frequently Asked Question</h2>
    ...
    return (
        <div className="rounded-[32px] border border-slate-200 bg-white p-10 shadow-xl shadow-slate-100">
            <div className="flex items-center gap-4">
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-blue-50 text-blue-600">{icon}</div>

                <h3 className="text-3xl font-bold text-slate-900">{title}</h3>
            </div>

            <p className="mt-8 leading-8 whitespace-pre-line text-slate-600">{content}</p>
