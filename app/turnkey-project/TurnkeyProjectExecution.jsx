...
const features = [
    ...
    },
    {
        ...
        description: 'Development of compressed air system designs that support efficient operation, reliable performance, and optimized lifecycle costs.',
    },
    {
    ...
    },
    {
        ...
        description: 'Coordination of mechanical, electrical, utility, and infrastructure activities to support efficient and organized project execution.',
    },
    {
        title: 'Testing, Validation & Commissioning',
        description: 'Verification of system performance through structured testing and commissioning activities before operational handover.',
    },
    {
        title: 'Documentation & Handover Support',
        description: 'Provision of project documentation, system information, and operational guidance to support smooth transition into plant operations.',
    },
];
...
const processSteps = [
    {
        ...
        description: 'Understanding production requirements, air demand profiles, plant conditions, utility infrastructure, and project objectives.',
    },
    {
        title: 'Engineering & System Design',
        description: 'Development of technical solutions based on performance requirements, operational goals, and future growth considerations.',
    },
    {
        title: 'Procurement & Resource Planning',
        description: 'Coordination of equipment, materials, project resources, and execution schedules.',
    },
    {
        title: 'Installation & Integration',
        description: 'Execution of system installation, piping infrastructure, utility connections, and equipment integration activities.',
    },
    {
        title: 'Testing & Commissioning',
        description: 'Performance verification and commissioning to ensure the system meets operational requirements.',
    },
    {
        title: 'Project Handover',
        description: 'Final documentation, operational readiness review, and structured project completion support.',
    },
];
...
const faqs = [
    {
        ...
        answer: 'Turnkey Project Execution typically includes project planning, engineering support, system design, equipment coordination, installation management, testing, commissioning, and project handover activities.',
    },
    {
        question: 'Who should consider Turnkey Project Services?',
        answer: 'Organizations planning new facilities, plant expansions, utility upgrades, or large-scale compressed air infrastructure projects can benefit from a turnkey execution model.',
    },
    {
        question: 'What are the advantages of a turnkey approach?',
        answer: 'A turnkey approach provides centralized coordination, improved accountability, streamlined communication, and better alignment across all project stages.',
    },
    {
        question: 'Can turnkey services support both new and existing facilities?',
        answer: 'Yes. Turnkey execution can support greenfield developments, brownfield expansions, retrofit projects, and modernization initiatives.',
    },
    {
        question: 'How does turnkey execution improve project outcomes?',
        answer: 'Through coordinated planning, structured execution, and integrated project management, turnkey delivery helps reduce delays, improve implementation quality, and support successful commissioning.',
    },
];
        ...
        <div className="bg-white">
            ...
            <section className="bg-slate-900 py-8 text-white md:py-20">
                <div className="container mx-auto max-w-7xl px-6">
                    <h1 className="mb-6 text-3xl font-bold md:text-5xl">Turnkey Project Execution</h1>

                    <h2 className="mb-6 text-lg font-medium text-blue-300 md:text-2xl">
                    ...
                    <div className="mt-10 flex flex-wrap gap-4">
                        <button onClick={() => setOpen(true)} className="rounded-lg bg-blue-600 px-6 py-3 font-medium transition hover:bg-blue-700">
                            Request Qoute
                        </button>
                ...
                <div className="container mx-auto max-w-7xl px-6">
                    ...
                    <div className="space-y-6 text-gray-700 xl:leading-relaxed">
                        <p>
                            ...
                            vendors often increases project complexity and can lead to delays, communication gaps, and execution challenges.
                        </p>

                        <p>
                            Turnkey Project Execution simplifies this process by providing a single point of responsibility throughout the project lifecycle.
                            This approach helps maintain alignment between project objectives, technical requirements, timelines, and operational expectations.
                        </p>

                        <p>
                            A structured turnkey model ensures that every stage of the project is planned and executed with consideration for performance,
            ...
            <section className="py-7 lg:py-12 xl:py-20">
                <div className="container mx-auto max-w-7xl px-6">
                    <div className="grid gap-12 lg:grid-cols-2">
                        ...
                        <div>
                            <h2 className="mb-8 text-2xl font-bold md:text-3xl">Typical Applications</h2>
