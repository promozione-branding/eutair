...
export default function TrustedBrands() {
    ...
    return (
        <section id="industries" className="relative overflow-hidden border-y border-cyan-200 bg-white py-6 md:py-10">
            <div className="mx-auto w-full px-10">
                <h3 className="mb-5 text-center text-sm font-bold tracking-[0.25em] text-blue-950 md:mb-10">TRUSTED BY LEADING INDUSTRIES</h3>
                ...
                >
                    {brands.map((logo, index) => (
                        <SwiperSlide key={index}>
                            <div className="flex h-24 items-center justify-center rounded-2xl border border-slate-200 bg-white px-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                                <Image
                                    src={logo.image}
                                    alt={logo.alt}
                                    width={200}
                                    height={180}
                                    className="h-23 w-auto object-contain transition-all duration-500"
                                />
                            </div>
                        </SwiperSlide>
                    ))}
