...
import { Clock3, Gauge, Wallet, Zap, ShieldCheck, Wrench, Volume2, Factory, Box, BadgeCheck } from 'lucide-react';
            ...
            <div className="mx-auto max-w-7xl px-5">
                ...
                <div className="mx-auto mb-14 max-w-4xl text-center">
                    ...
                    <p className="mt-6 text-lg leading-8 text-slate-600">
                        A screw air compressor is an ideal choice for businesses that need a continuous and dependable supply of compressed air. Built for
                        demanding industrial applications, these compressors deliver superior performance, excellent energy efficiency, smoother operation, and
                        lower operating costs compared to conventional compressors.
                    </p>
                </div>
                ...
                <div className="grid items-center gap-12 lg:grid-cols-2">
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute bottom-6 left-6 rounded-2xl bg-blue-600 px-6 py-5 text-white shadow-xl">
                            ...
                            <p className="text-sm tracking-wide uppercase">Continuous Operation</p>
                        </div>
                    </div>
                </div>
            </div>
