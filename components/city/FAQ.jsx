...
export default function FAQ({ city }) {
    ...
    return (
        <section className="relative bg-white px-4 py-4 md:px-8 md:py-7 lg:px-12">
            {/* Heading */}

            <h2 className="mb-3 text-center text-2xl font-extrabold text-[#07342A] md:mb-12 md:text-4xl">Frequently Asked Questions</h2>
