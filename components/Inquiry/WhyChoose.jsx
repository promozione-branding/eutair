...
const FeatureCard = ({ item }) => {
  ...
  return (
    <div className="group bg-white rounded-3xl border border-slate-200  hover:shadow-2xl transition-all duration-300 p-5 md:p-7 flex flex-col items-center justify-center text-center h-full">
      ...
      <h3 className="font-bold text-sm md:text-lg md:leading-7 text-slate-800">
        {item.title}
      </h3>
    </div>
  );
