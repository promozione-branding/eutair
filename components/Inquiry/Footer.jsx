      ...
      <footer className="bg-[#081B2E]  px-2 hidden md:block text-white relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 py-8 flex flex-col lg:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-slate-300 mt-2">
                Talk to our experts and find the right compressed air solution
                for your business.
              </p>
            </div>
          ...
          <div className="grid lg:grid-cols-5 gap-7">
            ...
            <div>
              ...
              <p className="text-white mt-8 leading-8">
                Leading Manufacturer, Trader, Exporter & Importer of Air
                Compressors, Air Dryers, Air Line Filters, Drain Valves and
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  <Phone className="text-cyan-500 shrink-0 mt-1" size={20} />
                  <div>
              ...
              <div className="flex items-start gap-4 mt-3">
                <Mail className="text-cyan-500 shrink-0 mt-1" size={20} />
                <div>
            ...
            <div className="relative overflow-hidden rounded-3xl  ">
              ...
              <div className="relative ">
                ...
                <p className="text-slate-200 ml-2 leading-6 text-[14px]">
                  ...
                  exceptional customer service, outstanding business practices,
                  and a dedication to building trust with their customers.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex py-5  gap-4 justify-center items-center max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row">
            <div className="flex   items-start gap-4">
              <MapPin className="text-cyan-500 shrink-0 mt-1" size={20} />
              <div>
                <p className="font-semibold text-white">Regd. Address</p>
                <p className="text-slate-300 leading-relaxed">
                  37C, 2nd Floor, Gate No. 3, Opp. IDBI Bank, Chaudhary Balbir
                  Singh Marg, A3 Block, Paschim Vihar, New Delhi - 110063
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-300 leading-relaxed">
                  T-3, Third Floor, Ansal Utility Tower, A2 Block, Paschim
